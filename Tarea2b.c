...
int main(){
	...
	switch(pid)
	{
		case 0:printf("Estoy en proceso padre\n");
			int buf, may = 0;
			...
			printf("Soy el proceso padre[PID: %d], y el mayor de mayores es: %d\n",getpid(), may);
			exit(0);
		case 1:
